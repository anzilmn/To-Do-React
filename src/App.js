          ...
          <ul className="todo-list">
            {this.state.todos.map((todo, index) => (
              <li key={todo.id} className="todo-item">
                ...
                <button className="todo-button" id='delete' onClick={() => this.handleDeleteTodo(todo.id)}>
                  
                  <img src={require("./delete.svg").default} />

                </button>
                <button className="todo-button" id='complete' onClick={() => this.handleToggleComplete(todo.id)}>
          ...
          <ul className="todo-list">
            {this.state.completedTodos.map((todo, index) => (
              <li key={todo.id} className="todo-item completed">
                ...
                <button className="todo-button" id='revert' onClick={() => this.handleToggleComplete(todo.id)}>
                <img src={require("./revert.svg").default} />
                </button>
              </li>
            ))}
          </ul>
